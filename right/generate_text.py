...
def generate_text_right(text, font_bin, video_bytes, text_color, canvas_width, canvas_height):
    ...
    # เปลี่ยนตำแหน่งข้อความเป็นครึ่งขวาของวิดีโอ
    text_clip = ImageClip(text_image_np).set_duration(clip.duration).set_position((clip.w // 2, "center")).crossfadein(0.5)
